    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1 class="page-header">Whoops...
                    <small> Let's head back.</small>
                </h1>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p class="text-center">Copyright &copy; <a href="www.chrisriouxdevelopment.com">Chris Rioux Development 2016</a></p>
                </div>
            </div><!-- /.row -->
        </footer>
